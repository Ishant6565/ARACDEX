              ...
              {authMode === 'google' && (
                <div className="space-y-3 text-left bg-[#09090c] border border-cyan-500/30 p-4 rounded-[4px] shadow-[0_0_30px_rgba(0,0,0,0.7)]">
                  ...
                  <button
                    ...
                    className="w-full py-3 px-4 bg-white hover:bg-zinc-100 text-zinc-900 font-sans font-bold text-xs uppercase tracking-wider rounded-[3px] transition-all shadow-[0_0_20px_rgba(255,255,255,0.2)] active:scale-95 flex items-center justify-center gap-2.5 cursor-pointer disabled:opacity-60"
                  >
                  ...
                  <div className="relative flex py-1 items-center">
                    ...
                    <span className="flex-shrink mx-2 text-[9px] font-mono text-zinc-500 uppercase">OR VIA GMAIL & PASSWORD</span>
                    <div className="flex-grow border-t border-white/10"></div>
                  </div>
